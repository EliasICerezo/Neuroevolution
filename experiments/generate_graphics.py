...
if __name__ == "__main__":
    ...
    for directory in directories:
      ...
      for selected_dataset in unique_datasets:
        ...
        plt.plot(x,max_fitness_list, 'v-' ,label='Max Fitness')
        plt.plot(x,min_fitness_list, 'o--' ,label='Min Fitness')
        plt.plot(x,median_fitness_list, 's:' ,label='Median Fitness')
        plt.xlabel('Epochs')
        plt.ylabel('GA Fitness')
        plt.title('GA Fitness for {} {}'.format(directory, selected_dataset))
        plt.legend()
        plt.savefig(os.path.join('processed_experiments',directory,'figures','GA_figure_{}_{}'.format(directory, selected_dataset)))
        plt.cla()
      ...
      for selected_dataset in unique_datasets:
        ...
        plt.plot(x,sa_list, 'v-', label="Simulated Annealing Fitness")
        plt.plot(x,es_list, 'o--', label="Evolutionary Strategy Fitness")
        plt.plot(x,ga_list, 's:', label="Genetic Algorithm Fitness")
        plt.xlabel('Epochs')
        plt.ylabel('Fitness')
        plt.title('Fitness for {} {}'.format(directory, selected_dataset))
        plt.legend()
        plt.savefig(os.path.join('processed_experiments',directory,'figures','Fitness_figure_{}_{}'.format(directory, selected_dataset)))
        plt.cla()